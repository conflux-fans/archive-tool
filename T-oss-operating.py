    ...
    def write_bash(self, write_file_name_bash:str):
        try:
            ...
            with open(write_file_name_bash, 'a') as f:
                ...
                f.write("Download_path=https://conflux-blockchain-data.oss-cn-beijing.aliyuncs.com/archive-db/T/" + self.project_name + "-${Date}" + ".tar.gz" + "\n")
    ...
    def write_bat(self, write_file_name_bat:str):
        try:
            ...
            with open(write_file_name_bat, 'a') as f:
                ...
                f.write("set Download_path=https://conflux-blockchain-data.oss-cn-beijing.aliyuncs.com/archive-db/T/" + self.project_name + "-%Date%" + ".tar.gz" + "\n")
...
if __name__ == '__main__':
    ...
    bucket_prefix = "archive-db" + "/" + "T" + "/" + keyname
    bucket_prefix_bash = "archive-db" + "/" + "T" + "/" + keyname_bash
    bucket_prefix_bat = "archive-db" + "/" + "T" + "/" + keyname_bat
