    ...
    def write_bash(self, write_file_name_bash:str):
        try:
            with open(write_file_name_bash, 'w') as f:
                ...
                f.write("#Retain for 1 days, every day at 6 a.m 、18 p.m backup, format: year, month, day, hour\n")
            ...
            with open(write_file_name_bash, 'a') as f:
                ...
                f.write("Download_path=https://conflux-blockchain-data.oss-cn-beijing.aliyuncs.com/archivenode-db/T/" + self.project_name + "-${Date}" + ".tar.gz" + "\n")
    ...
    def write_bat(self, write_file_name_bat:str):
        try:
            ...
            with open(write_file_name_bat, 'a') as f:
                ...
                f.write("set Download_path=https://conflux-blockchain-data.oss-cn-beijing.aliyuncs.com/archivenode-db/T/" + self.project_name + "-%Date%" + ".tar.gz" + "\n")
...
if __name__ == '__main__':
    ...
    bucket_prefix = "archivenode-db" + "/" + "T" + "/" + keyname
    bucket_prefix_bash = "archivenode-db" + "/" + "T" + "/" + keyname_bash
    bucket_prefix_bat = "archivenode-db" + "/" + "T" + "/" + keyname_bat
