    ...
    def write_bash(self, write_file_name_bash:str):
        try:
            ...
            with open(write_file_name_bash, 'a') as f:
                ...
                f.write("Download_path=https://conflux-blockchain-data.oss-cn-beijing.aliyuncs.com/fullnode-db/M/" + self.project_name + "-${Date}" + ".tar.gz" + "\n")
    ...
    def write_bat(self, write_file_name_bat:str):
        try:
            ...
            with open(write_file_name_bat, 'a') as f:
                ...
                f.write("set Download_path=https://conflux-blockchain-data.oss-cn-beijing.aliyuncs.com/fullnode-db/M/" + self.project_name + "-%Date%" + ".tar.gz" + "\n")
...
if __name__ == '__main__':
    ...
    bucket_prefix = "fullnode-db" + "/" + "M" + "/" + keyname
    bucket_prefix_bash = "fullnode-db" + "/" + "M" + "/" + keyname_bash
    bucket_prefix_bat = "fullnode-db" + "/" + "M" + "/" + keyname_bat
    ...
    """
    process_name = "conflux_M"
    conflux_version = getoutput('/data/M/conflux-service/conflux_M --version')
    start_shell = "bash /data/M/conflux-service/start.sh"
    dingding_url = "xxx"
    dingding_title = "Conflux fullnode-snapshot-M_BJ"
    ...
    """
    workdir = "/data/M/conflux-service"
    ...
    exe_print_log = "tail -n -100 /data/M/conflux-service/log/conflux.log |grep -wi 'Catch-up mode: false'"
    ...
    try:
        ...
        if T[0] == 'True':
            ...
            getoutput('rm -f /data/M/conflux-service/pos_config/pos_key')
            ...
            P_T = Process_operating("conflux_T", "/data/T/logs/check-conflux-status.txt")
            P_T.kill_process()
        else:
